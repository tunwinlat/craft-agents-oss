...
// Web stub - using console instead of electron-log
const perfLog = {
  debug: (...args: unknown[]) => console.debug('[perf]', ...args),
  info: (...args: unknown[]) => console.info('[perf]', ...args),
  warn: (...args: unknown[]) => console.warn('[perf]', ...args),
  error: (...args: unknown[]) => console.error('[perf]', ...args),
}
